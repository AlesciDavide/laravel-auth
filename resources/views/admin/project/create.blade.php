        ...
        <div class="col-12">
            <form action="{{ route('admin.project.store') }}" method="POST" id="creation_form">
                ...
                <div class="input-group-sm container mb-5 w-50">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="linguaggio_utilizzato dell'animale" id="linguaggio_utilizzato" name="linguaggio_utilizzato" value="{{ old('linguaggio_utilizzato') }}">

                    <label for="url_repo">url_repo</label>
                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="url_repo dell'animale" id="url_repo" name="url_repo" value="{{ old('url_repo') }}">
